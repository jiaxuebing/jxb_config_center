...
public class RedisDelayQueue {
     ...
     * @param score
     */
    public void add(Object member,long score){
    ...
    public void filterDelayData(long score){
        //考虑分布式的情况需要加分布式锁
        Set<Object> delaySet = redisTemplate.opsForZSet().rangeByScore(delayZsetkey,-1,score);
        //将满足条件的元素存放到list中，供其他消费者消费
        if(delaySet!=null){
            for(Object delay:delaySet){
                //将满足条件的元素从zset中删除
     ...
     * @return
     */
    public Object getDelayListData(){
     ...
     * @date 2020-04-12
     */
    public void delDelayData(Object member){
        //将待执行集合中的任务删除
